( function( $ ) {
	...
	if ( rtwwcfml_ajax_param.enable_mltistep && rtwwcfml_ajax_param.enable_mltistep == '1' ) {
		...
		if ( rtwwcfml_ajax_param.rtwwcfml_tab_color ) {
		    $(document).find('.rtwwcfml_move_selector').css('background', rtwwcfml_ajax_param.rtwwcfml_tab_color);
		}
		if ( rtwwcfml_ajax_param.rtwwcfml_tab_font ) {
			$(document).find('.rtwwcfml_tab_wrapper nav a').css('font-size', rtwwcfml_ajax_param.rtwwcfml_tab_font);
		}
		if ( rtwwcfml_ajax_param.rtwwcfml_stripe_clor ) {
			$(document).find('.rtwwcfml_tab_wrapper').css('background-color',rtwwcfml_ajax_param.rtwwcfml_stripe_clor);
		}
	}else{
		wpcf7.taggen.insert = function( content ) {
			$( 'textarea#wpcf7-form' ).each( function() {
